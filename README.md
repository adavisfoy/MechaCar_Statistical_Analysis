...
- **Does this linear model predict mpg of MechaCar prototypes effectively? Why or why not?**
  ...
  - In our case, our r-squared value = 0.7149 indicating that our linear model is a respectable predictor of mpg for future MechaCar prototypes. An r-squared of 0.7149 means that approximately 71% of the variability in our dependent variable (mpg) is explained by our linear model. Our p-value also remained significant at .0000000000535. There is a strong correlation between the independent variables of vehicle length and ground clearance on our dependent variable (mpg). 
